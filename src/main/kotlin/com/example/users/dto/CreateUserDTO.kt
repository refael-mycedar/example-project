...
import com.example.users.validation.UniqueEmail
import com.example.users.validation.ValidFilterOperation
...
class CreateUserDTO(
    ...
    @field:ValidFilterOperation(message = "Operation is not allowed")
    @field:UniqueEmail(message = "Email must be unique")
